...
document.getElementById('capture').onchange = function (evt) {
    ...
    // Not supported
        ...
        //HTTP Post Request
        var URL = "https://centralindia.api.cognitive.microsoft.com/customvision/v3.0/Prediction/b1b5fb28-2a30-4635-9302-c6bc026d1871/classify/iterations/SnakeClassification/image";
        var xhr = new XMLHttpRequest();
        
        xhr.open('POST', URL, true);
        xhr.setRequestHeader('Prediction-Key','5db074e7ba644046b0aaaacdad018940');
